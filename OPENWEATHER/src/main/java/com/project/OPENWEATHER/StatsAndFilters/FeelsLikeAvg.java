...
public class FeelsLikeAvg implements FiltersStatistics {
	...
	/**
	 * Questo metodo calcola la media delle temperature percepite delle città di 1
	 * giorno
	 * 
	...
	/**
	 * 
	 * Questo metodo calcola la media delle temperature percepite delle città di 5
	 * giorni
	 * 
	 * @param cities contiene le varie città
	 * @return array con temperatura desiderata
