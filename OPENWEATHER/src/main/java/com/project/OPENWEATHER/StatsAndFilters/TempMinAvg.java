...
public class TempMinAvg implements FiltersStatistics {
	...
	/**
	 * Questo metodo calcola la media delle temperature minime delle città di 1
	 * giorno
	 * 
	...
	public JSONArray Day1Avg(ArrayList<String> cities) throws MalformedURLException, IOException, ParseException {
		...
		ArrayList<Double> avgMinTemp = new ArrayList<Double>();
	...
	/**
	 * Questo metodo calcola la media delle temperature minime delle città di 5
	 * giorni
	 * 
	 * @param cities contiene le varie città
	 * @return array con temperatura desiderata
