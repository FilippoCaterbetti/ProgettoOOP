...
public class Temperature implements Cloneable { // JSONClass,
	 ...
	 * 
	 * @param temperature un JSONObject da parsare per costruire il dato meteo
	 * 
	 *                    Il JSONObject deve avere questa struttura "temp"
	 *                    temperatura "feels_like" temperatura percepita "temp_max"
	 *                    temperatura massima "temp_min" temperatura minima
	 *                    "temp_avg" temperatura media "data" data della misurazione
	 * 
	 */
	...
	/**
	 * JSONObject contenente tutti i dati del rilevamento
	 * 
